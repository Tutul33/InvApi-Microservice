...
namespace InvApi.InterCom.RabbirMQListener
{
    public class RabbitMqConsumerService : BackgroundService
    {
        ...
        {
            var queues = new List<string> { "orderQueue", "inventoryQueue" };
                    ...
                    try
                    {
                        switch (queueName)
                        {
                            case "orderQueue":
                                ...
                                break;
                            //case "inventoryQueue":
                            //    var inventoryCommand = JsonSerializer.Deserialize<UpdateInventoryCommand>(decodedMessage, options);
